    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="px-4 pt-6 pb-2 md:px-8 flex items-start justify-between">
        ...
        <button
          ...
          className="bg-[#1A56DB] text-white text-sm px-4 py-2 rounded-md flex items-center gap-2 hover:opacity-90 transition-opacity active:scale-[0.97]"
        >
      ...
      <div className="px-4 pb-8 md:px-8 space-y-8 mt-4">
        {/* Grants List */}
        <section>
